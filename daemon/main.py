...
def main():
    ...
    if args.config_check:
        try:
            ...
            logger.info("")
            logger.info("[timing]")
            logger.info(f"  sigterm_delay = {config.timing.sigterm_delay}")
            logger.info(f"  sigkill_delay = {config.timing.sigkill_delay}")
            logger.info("")
            logger.info("[colors]")
            logger.info(f"  backdrop = {config.colors.backdrop}")
            logger.info(f"  backdrop_opacity = {config.colors.backdrop_opacity}")
            logger.info(f"  modal_bg = {config.colors.modal_bg}")
            logger.info(f"  modal_border = {config.colors.modal_border}")
            logger.info(f"  text_primary = {config.colors.text_primary}")
            logger.info(f"  text_secondary = {config.colors.text_secondary}")
            logger.info(f"  accent_danger = {config.colors.accent_danger}")
            logger.info(f"  status_alive = {config.colors.status_alive}")
            logger.info(f"  status_closed = {config.colors.status_closed}")
            logger.info("")
            logger.info("[ui]")
